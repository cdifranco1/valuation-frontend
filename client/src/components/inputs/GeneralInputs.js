  ...
  return (
    ...
    {modelId === "new" ?
      <div className="flex justify-end">
        ...
        :
      <button type="button" onClick={handleSubmit} className="p-4 w-full mt-3 bg-white text-blue-800 hover:bg-blue-700 hover:text-white text-xl focus:outline-none focus:shadow-outline">Save Assumptions</button>}
    </div>
  )
}
