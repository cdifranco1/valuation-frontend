...
export default ({ buttonText, onClick, direction }) => {
  return (
    direction === "right" ?
    <button type="button" onClick={onClick} className="mt-8 flex justify-between items-center p-4 w-full mt-3 bg-white text-blue-800 shadow-md focus:outline-none focus:shadow-outline hover:bg-blue-700 arrow-fill hover:text-white text-2xl">     
      {buttonText}
